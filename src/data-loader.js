...
export async function loadAllData(){
  const [hexagrams,najia,sixSpirits,xunkong,branchRelations,strengthWeights,questionCategories,judgementRules,enginePipeline,sourceCatalog,rulePack]=await Promise.all([
    ...
    getJson('./rules/source-catalog.json'),getJson('./rules/rule-pack.json')
  ]);
  return {hexagrams,najia,sixSpirits,xunkong,branchRelations,strengthWeights,questionCategories,judgementRules,enginePipeline,sourceCatalog,rulePack};
}
